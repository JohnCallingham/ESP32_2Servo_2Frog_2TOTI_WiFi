//
//  OpenLCBHeaderJC.h modified from OpenLCBHeader.h in August 2025.
//  #define CDIheader changed;-
//   - segment is named "Configuration".
//   - group configured to be not visible on start up.
//  
//
...
<!--        <softwareVersion>" __DATE__ " " __TIME__ "</softwareVersion>  modified by JC -->\
        <softwareVersion>" SWVERSION "</softwareVersion> <!-- modified by JC -->\
        </identification>\
    <segment origin='4' space='253'> <!-- bypasses magic, nextEID, nodeID -->\
        <name>Configuration</name> <!-- added by JC -->\
        <group>\
            <hints><visibility hideable='yes' hidden='yes'></visibility></hints> <!-- added by JC -->\
            <name>Node ID</name>\
